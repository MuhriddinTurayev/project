<?php
   ...
   $sea=$_POST['sea'];
   echo $sea;
   $select = "SELECT * FROM manzil    WHERE  `title_uz` LIKE '%$sea%' or `title_en` LIKE '%$sea%'  or `title_ru` LIKE '%$sea%'  or `body_uz` LIKE '%$sea%'  or `body_en` LIKE '%$sea%'  or `body_ru` LIKE '%$sea%'  ";
...
<header>
    ...
    <form action="" method="post" class="search-bar-container">
        ...
        <input for="search-bar" class="btn" type="submit" class="fas fa-search">
    </form>
