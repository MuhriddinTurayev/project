<?php
  ...
  try{
    ...
    if(isset($_GET['delete'])){
      $smtp = $connection->prepare("DELETE FROM `gallery` WHERE  id=:id ");
  ...
  border: 1px solid #000;
    ...
    <body>
        ...
        <main class="container section">
          <div class="service">
            <h1>Portfolio</h1>
            <a href="gallery_add.php">Add Portfolio</a>
            <form action="">
        ...
        <div class="table">
          <div class="table-header">
            ...
            <div class="header__item"><a id="draws" class="filter__link filter__link--number" href="#">Title_uz</a></div>
            <div class="header__item"><a id="losses" class="filter__link filter__link--number" href="#">Text_uz</a></div>
