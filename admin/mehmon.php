<?php
  ...
  try{
    ...
    if(isset($_GET['delete'])){
      $smtp = $connection->prepare("DELETE FROM `mehmon` WHERE  id=:id ");
  ...
  border: 1px solid #000;
    ...
    <body>
        ...
        <main class="container section">
          <div class="service">
            <h1>Portfolio</h1>
            <a href="mehmon_add.php">Add Portfolio</a>
            <form action="">
                               ...
                               if($result->num_rows > 0){
                                        while ($row = mysqli_fetch_array($result, MYSQLI_ASSOC)){
                                                ...
                                                <div class="table-row">		
                                                  ...
                                                  <form action="mehmon_add.php" method="POST">
