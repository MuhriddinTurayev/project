<?php
          ...
          $select = "SELECT * FROM dacha WHERE id = '$id'";
          ...
          try{
            ...
            if(isset($_POST['add'])){
                      $smtp = $connection->prepare("INSERT INTO dacha (img, title_uz, title_en, body_uz, body_en, narx, foiz, body_ru, title_ru, titlee_uz, titlee_ru, titlee_en ) VALUES ( :img,  :title_uz, :title_en, :text_uz, :text_en, :narx, :foiz, :text_ru, :title_ru, :titlee_uz, :titlee_ru, :titlee_en)");
                ...
                if(isset($_POST['update'])){
                  ...
                  if($tmpname != ""){
                    $smtp = $connection->prepare("UPDATE  `dacha` SET  img=:img , title_uz=:title_uz, title_en=:title_en, body_uz=:body_uz, body_en=:body_en, narx=:narx, foiz=:foiz, title_ru=:title_ru, body_ru=:body_ru, titlee_uz=:titlee_uz, titlee_ru=:titlee_ru, titlee_en=:titlee_en   WHERE id=:id");
                    ...
                    $smtp->execute();
                    header("location: dacha.php");
                    $success[] = "Muvaffaqiyatli yuklandi!";
          } else{
                    $smtp = $connection->prepare("UPDATE  `dacha` SET   title_uz=:title_uz, title_en=:title_en, body_uz=:body_uz, body_en=:body_en,  narx=:narx, foiz=:foiz,  title_ru=:title_ru, body_ru=:body_ru, titlee_uz=:titlee_uz, titlee_ru=:titlee_ru, titlee_en=:titlee_en   WHERE id=:id");
                    $smtp->bindParam(':id', $_POST['id']);
                    $smtp->bindParam(':title_uz', $_POST['title_uz']);
                    $smtp->bindParam(':title_en', $_POST['title_en']);
                    $smtp->bindParam(':body_uz', $_POST['text_uz']);
