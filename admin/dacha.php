<?php
  ...
  try{
    ...
    if(isset($_GET['delete'])){
      $smtp = $connection->prepare("DELETE FROM `dacha` WHERE  id=:id ");
  ...
  border: 1px solid #000;
    ...
    <body>
        ...
        <main class="container section">
          <div class="service">
            <h1>Portfolio</h1>
            <a href="dacha_add.php">Add Portfolio</a>
            <form action="">
          ...
          <?php
                               if($result->num_rows > 0 ){
                                        while ($row = mysqli_fetch_array( $result, MYSQLI_ASSOC)){
                                                  ?>
                                                  <?php if($row['id']==2) echo $row['title_uz']. "span". "dcdvdsj". "</span>" ?>
                                                <div class="table-row">		
                                                  <div class="table-data"><?=$row['id']?>
                                                  ...
                                                  <form action="dacha_add.php" method="POST">
