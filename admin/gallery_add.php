<?php
          ...
          try{
            ...
            if(isset($_POST['add'])){
                      $smtp = $connection->prepare("INSERT INTO manzil (img, title_uz, title_en, body_uz, body_en, title_ru, body_ru ) VALUES ( :img, :title_uz, :title_en, :text_uz, :text_en, :title_ru, :text_ru)");
                ...
                if(isset($_POST['update'])){
                  ...
                  if($tmpname != ""){
                    $smtp = $connection->prepare("UPDATE  `manzil` SET  img=:img , title_uz=:title_uz, title_en=:title_en, body_uz=:body_uz, body_en=:body_en, title_ru=:title_ru, body_ru=:body_ru  WHERE id=:id");
                    ...
                    $smtp = $connection->prepare("UPDATE  `gallery` SET   title_uz=:title_uz, title_en=:title_en, body_uz=:body_uz, body_en=:body_en, title_ru=:title_ru, body_ru=:body_ru WHERE id=:id");
                    $smtp->bindParam(':id', $_POST['id']);
                    $smtp->bindParam(':title_uz', $_POST['title_uz']);
                    $smtp->bindParam(':title_en', $_POST['title_en']);
                    $smtp->bindParam(':body_uz', $_POST['text_uz']);
  ...
  color: #888;
    ...
    <body>
        ...
        <main class="container section">
                    ...
                    <fieldset>
                        <input placeholder="Portfoli Name en" type="text" tabindex="3" value="<?php if($key == 1) echo $title_en_ser?>" name="title_ru">
                    </fieldset>
                    <fieldset>
                        <textarea placeholder="Text en"  tabindex="3"  name="text_ru"><?php if($key == 1) echo $text_en_ser?></textarea>
                    </fieldset>
                    <fieldset>
