<?php
          ...
          $select = "SELECT * FROM home1 WHERE id = '$id'";
          ...
          try{
            ...
            if(isset($_POST['add'])){
                      $smtp = $connection->prepare("INSERT INTO home1 (video ) VALUES ( :video)");
                    ...
                    if(isset($_POST['update'])){
                        ...
                        if($tmpname != ""){
                          $smtp = $connection->prepare("UPDATE  `home1` SET  video=:video  WHERE id=:id");
                          ...
                          $smtp = $connection->prepare("UPDATE  `home1` SET   title_uz=:title_uz WHERE id=:id");
                          $smtp->bindParam(':id', $_POST['id']);
