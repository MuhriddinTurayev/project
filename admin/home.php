...
<head>
    ...
    <link rel="preconnect" href="https://fonts.googleapis.com"><link rel="preconnect" href="https://fonts.gstatic.com" crossorigin><link href="https://fonts.googleapis.com/css2?family=Chivo+Mono:ital,wght@1,900&display=swap" rel="stylesheet">
    <title>Document</title>
    <style> @import url('https://fonts.googleapis.com/css2?family=Chivo+Mono:ital,wght@1,900&display=swap'); </style>
</head>
<body>
    <!--Main Header-->
...
<?php
  ...
  try{
    ...
    if(isset($_GET['delete'])){
      $smtp = $connection->prepare("DELETE FROM `home1` WHERE  id=:id ");
  ...
  border: 1px solid #000;
    ...
    <body>
        ...
        <main class="container section">
          <div class="service">
            <h1>Portfolio</h1>
            <a href="home_add.php">Add Portfolio</a>
                                        ...
                                        while ($row = mysqli_fetch_array($result, MYSQLI_ASSOC)){
                                                ...
                                                <div class="table-row">		
                                                  ...
                                                  <div class="table-data">
                                                            <video src="./video/<?=$row['video']?>" alt="" width="100px">
                                                  ...
                                                  <form action="home_add.php" method="POST">
